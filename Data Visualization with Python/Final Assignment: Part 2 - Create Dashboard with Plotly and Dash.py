...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
	...
	# Hint:Use unemployment_rate,Vehicle_Type and Automobile_Sales columns
        unem_type_sales = recession_data.groupby(['unemployment_rate','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(figure = px.bar(unem_type_sales, x = 'unemployment_rate', y = 'Automobile_Sales', title = 'Effect of unemployment rate on vehicle type and sales'))
...
# Plot 2 Total Monthly Automobile sales using line chart.
        tas = data.groupby('Month')['Automobile_Sales'].mean().reset_index()
        Y_chart2 = dcc.Graph(figure = px.line(tas, x = 'Month', y = 'Automobile_Sales', title = 'Total Monthly Automobile sales'))
